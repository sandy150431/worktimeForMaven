						...
						<div class="panel panel-info" style="border-color: white;">
							...
							<form id="postForm" action="" method="post">
								<div class="panel-body">
									...
									<div class="form-group required fontChinese" style="height: 30px;">
										<label for="resignDate" class="control-label col-md-4  requiredField" style="font-family: Microsoft JhengHei;">離職日</label>
										<div class="controls col-md-8 ">
								...
								<div class="contentTitle" id="contentTitle">
									<div class="col-lg-12">
										...
										<input id="update" type="button" value="修改" class="btn btn-skin btn-lg" style="font-family: Microsoft JhengHei;" />

										<!-- button純粹轉址 -->
										<input id="reSearch" type="button" value="重新查詢" class="btn btn-skin btn-lg" style="font-family: Microsoft JhengHei;">
										<input id="delete" type="button" value="刪除" class="btn btn-skin btn-lg" style="font-family: Microsoft JhengHei;" />
									</div>
								</div>
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#update").click(function() {
				form.attr('action', 'preupdateEmp');
				form.submit();
			})
			$("#delete").click(function() {
				form.attr('action', 'deleEmp');
				form.submit();
			})
			$("#reSearch").click(function() {
				form.attr('action', 'displayAllEmp');
				form.submit();
			})
		})
	</script>
