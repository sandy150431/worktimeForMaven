						...
						<div
							...
							<div class="panel panel-info" style="border-color: white;">
								...
								<div class="contentTitle" id="contentTitle"
									style="font-family: Microsoft JhengHei;">離職註記</div>
								...
								<div class="panel-body">
									...
									<div class="form-group required fontChinese"
										...
										<label for="empNo"
											...
											style="font-family: Microsoft JhengHei;">員工編號</label>
										<div class="controls col-md-8 ">
											<label class="control-label col-md-4  requiredField"
												style="width: 500px;"> ${emp.empNo}</label>
										</div>
									</div>
									...
									<div class="form-group required fontChinese"
										...
										<label for="empName"
											class="control-label col-md-4  requiredField"
											style="font-family: Microsoft JhengHei;">員工姓名</label>
										<div class="controls col-md-8 ">
											<label class="control-label col-md-4  requiredField"
												style="width: 500px; font-family: Microsoft JhengHei;">
												${emp.empName}</label>
										</div>
									</div>
									...
									<div class="form-group required" style="height: 30px;">
										<label for="resign"
											class="control-label col-md-4  requiredField"
											style="font-family: Microsoft JhengHei;">是否離職</label>
										<div class="controls col-md-8 " style="margin-bottom: 10px">
											<label class="control-label col-md-4  requiredField"
												style="width: 500px;"> <input type="radio"
												name="resign" checked value=1 style="margin-bottom: 10px">是
											</label>
										</div>
									</div>
									...
									<div class="form-group required" style="height: 30px;">
										<label for="authority"
											class="control-label col-md-4  requiredField"
											style="font-family: Microsoft JhengHei;">離職日期</label>
										<div class="controls col-md-8 ">
											<input type="text" value="${emp.resignDate}"
												name="resignDate" required placeholder="yyyy-mm-dd"
												class="input-md  textinput textInput form-control"
												style="margin-bottom: 10px; font-family: Microsoft JhengHei;"
												type="text" />
										</div>
									</div>
									<!-- 內容結束 -->
								...
								<div class="contentTitle" id="contentTitle">
									<div class="col-lg-12">
										<input type="submit" name="action" value="修改離職註記"
											class="btn btn-skin btn-lg">

										<!-- button純粹轉址 -->
										<input type="button"
											onclick="javascript:location.href='adminResignFind.jsp'"
											value="重新查詢" class="btn btn-skin btn-lg"> <input
											type="submit" name="action" value="刪除離職註記"
											class="btn btn-skin btn-lg">
									</div>
								</div>
